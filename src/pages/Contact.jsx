    ...
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white dark:bg-dark-200 rounded-xl shadow-md p-8"
        >
        ...
        >
          <div className="bg-white dark:bg-dark-200 rounded-xl shadow-md p-8">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg className="w-6 h-6 text-primary-light dark:text-primary-dark mr-4 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <div>
                  <h4 className="font-medium">Adresse</h4>
                  <p className="text-gray-600 dark:text-gray-300">123 Rue de la Blockchain, 75000 Paris, France</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">contact@cryptovision.com</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white dark:bg-dark-200 rounded-xl shadow-md p-8">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-dark-300 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:bg-primary-light hover:text-white dark:hover:bg-primary-dark transition-colors">
